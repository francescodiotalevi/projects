...
proc create_root_design { parentCell } {
  ...
  set IIC_ZTURN [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 IIC_ZTURN ]
...
CONFIG.PCW_WDT_WDT_IO {<Select>} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_ports IIC_ZTURN] [get_bd_intf_pins processing_system7_0/IIC_0]
...
preplace port MEMS_INTn -pg 1 -y 140 -defaultsOSRD
preplace port IIC_ZTURN -pg 1 -y 110 -defaultsOSRD
preplace port TEMP_INTn -pg 1 -y 160 -defaultsOSRD
