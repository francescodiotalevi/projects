...
proc create_root_design { parentCell } {
  ...
  # Create instance: axilite, and set properties
  set axilite [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:5.1 axilite ]
  set_property -dict [ list CONFIG.C_NUM_OF_PROBES {19} CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI4LITE}  ] $axilite

  # Create instance: mm2s, and set properties
  set mm2s [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:5.1 mm2s ]
  ...
  set s2mm [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:5.1 s2mm ]

  # Create instance: sg, and set properties
  set sg [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:5.1 sg ]

  # Create instance: stream, and set properties
  set stream [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:5.1 stream ]
  set_property -dict [ list CONFIG.C_NUM_OF_PROBES {9} CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI4S}  ] $stream
...
connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins stream/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins mm2s/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins s2mm/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net axi_dma_0_M_AXI_SG [get_bd_intf_pins axi_dma_0/M_AXI_SG] [get_bd_intf_pins sg/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins axilite/SLOT_0_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axilite/clk] [get_bd_pins mm2s/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins s2mm/clk] [get_bd_pins sg/clk] [get_bd_pins stream/clk]
